...
import img from '../assets/style/Carrusel.scss'
...
const Carrusel = () =>{
  ...
  <section className="carousel">
    ...
    <h3 className="categories__title">Mi lista de CDAMLI</h3>
  ...
  <h3 className="categories__title">Tendencias CDAMLI</h3>
  ...
  <h3 className="categories__title">Originales de CDAMLI</h3>
